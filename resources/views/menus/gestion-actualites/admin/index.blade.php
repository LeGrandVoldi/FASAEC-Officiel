...
<head>
  ...
  <!-- base:css -->
  <link rel="stylesheet" href={{ asset("Gestion_pubs/vendors/mdi/css/materialdesignicons.min.css") }}>
  <link rel="stylesheet" href={{ asset("Gestion_pubs/vendors/css/vendor.bundle.base.css") }}>
  <!-- endinject -->
  <!-- plugin css for this page -->
  <!-- End plugin css for this page -->
  <!-- inject:css -->
  <link rel="stylesheet" href={{ asset("Gestion_pubs/css/style.css") }}>
  <!-- endinject -->
...
<body>
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a  href="index.html"><img src={{ asset("img/logo1.png") }} alt="logo" width="60px" height="60px" /></a>
          </div>
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1"> FASAEC</h4>
  ...
  <!-- base:js -->
  <script src={{ asset("Gestion_pubs/vendors/js/vendor.bundle.base.js") }}></script>
  <!-- endinject -->
  <!-- Plugin js for this page-->
  <script src={{ asset("Gestion_pubs/vendors/chart.js/Chart.min.js") }}></script>
  <script src={{ asset("Gestion_pubs/js/jquery.cookie.js") }} type="text/javascript"></script>
  <!-- End plugin js for this page-->
  <!-- inject:js -->
  <script src={{ asset("Gestion_pubs/js/off-canvas.js") }}></script>
  <script src={{ asset("Gestion_pubs/js/hoverable-collapse.js") }}></script>
  <script src={{ asset("Gestion_pubs/js/template.js") }}></script>
  <!-- endinject -->
  <!-- plugin js for this page -->
    <script src={{ asset("Gestion_pubs/js/jquery.cookie.js") }} type="text/javascript"></script>
  <!-- End plugin js for this page -->
  <!-- Custom js for this page-->
  <script src={{ asset("Gestion_pubs/js/dashboard.js") }}></script>
